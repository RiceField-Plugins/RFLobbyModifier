...
namespace RFServerMess
{
    public class Plugin : RocketPlugin<Configuration>
    {
        ...
        private void EditServer()
        {
            ...
            string gameTags = string.Concat(new[]
            {
                Conf.EditIsPvP ? editIsPvP : origIsPvP,
                ",",
                Conf.EditHasCheats ? editHasCheats : origHasCheats,
                ",",
                Conf.EditMode ? editMode : origMode,
                ",",
                Conf.EditPerspective ? editPerspective : origCameraMode,
                ",",
                Conf.EditWorkshop ? editWorkshop : origWorkshop,
                ",", 
                Conf.EditIsGold ? editIsGold : origIsGold,
                ",", 
                Conf.EditIsBattlEyeSecure ? editBattlEyeSecure : origBattlEyeSecure,
                ",", 
                Conf.EditMonetization ? editMonetization : origMonetization,
                ",<tn>", Conf.EditThumbnail ? editThumbnail : origThumbnail, "</tn>",
            });
            ...
            if (Conf.RevertOnUnload)
            {
                ...
                OrigServerModel.BrowserIcon = origBrowserIcon;
                OrigServerModel.CustomLinks = origCustomLinks;
                OrigServerModel.MapName = origMapName;
                OrigServerModel.MapVersion = origMapVersion;
                OrigServerModel.MaxPlayers = origMaxPlayer;
                OrigServerModel.ServerName = origServerName;
                OrigServerModel.ServerPassword = origServerPassword;
                OrigServerModel.VacSecure = origVacSecure;
                OrigServerModel.BrowserDescriptionFull = origBrowserDescriptionFull;
                OrigServerModel.BrowserDescriptionHint = origBrowserDescriptionHint;
                OrigServerModel.DescriptionServerList = origDescriptionServerList;
                OrigServerModel.GameVersionPacked = origGameVersionPacked;
                OrigServerModel.GameVersion = origGameVersion;
                OrigServerModel.ServerWorkshopFileIDs = origServerWorkshopFileIDs;

                OrigGameTagsModel = new GameTagsModel();
                OrigGameTagsModel.Mode = origMode;
                OrigGameTagsModel.Monetization = origMonetization;
                OrigGameTagsModel.Thumbnail = origThumbnail;
                OrigGameTagsModel.Workshop = origWorkshop;
                OrigGameTagsModel.CameraMode = origCameraMode;
                OrigGameTagsModel.HasCheats = origHasCheats;
                OrigGameTagsModel.IsGold = origIsGold;
                OrigGameTagsModel.NetTransport = origNetTransport;
                OrigGameTagsModel.PluginFramework = origPluginFramework;
                OrigGameTagsModel.BattlEyeSecure = origBattlEyeSecure;
                OrigGameTagsModel.IsPvP = origIsPvP;
            }
        }
        ...
        private void RevertServer()
        {
            try
            {
                ...
                if (Conf.EditDescriptionServerList)
                {
                    ...
                    {
                        CommandWindow.LogWarning("Server browser thumbnail URL is " + (OrigServerModel.DescriptionServerList.Length - 64) + " characters over budget!");
                ...
                if (Conf.EditCustomLinks)
                {
                    ...
                    {
                        SteamGameServer.SetKeyValue("Custom_Links_Count", OrigServerModel.CustomLinks.Length.ToString());
                        for (var n = 0; n < OrigServerModel.CustomLinks.Length; n++)
                        {
                            SteamGameServer.SetKeyValue("Custom_Link_Message_" + n, OrigServerModel.CustomLinks[n].Message);
                ...
                string gameTags = string.Concat(new[]
                {
                    OrigGameTagsModel.IsPvP,
                    ",",
                    OrigGameTagsModel.HasCheats,
                    ",",
                    OrigGameTagsModel.Mode,
                    ",",
                    OrigGameTagsModel.CameraMode,
                    ",",
                    OrigGameTagsModel.Workshop,
                    ",", 
                    OrigGameTagsModel.IsGold,
                    ",", 
                    OrigGameTagsModel.BattlEyeSecure,
                    ",", 
                    OrigGameTagsModel.Monetization,
                    ",<tn>", OrigGameTagsModel.Thumbnail, "</tn>",
                });
                // if (Conf.EditNetTransport) ;
                //     gameTags += $",<net>{editNetTransport}</net>";
                // if (Conf.EditPluginFramework) ;
